  ...
  return <section className="mx-auto max-w-3xl">
    ...
    <div className="mt-6 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      {status?.configurada && <div className="mt-6 flex flex-wrap gap-3">
        {!criada && <button type="button" disabled={carregando || !status.disponivel} onClick={() => void executar('criarInstancia', 'Instância criada.')} className="btn-primary">Criar instância</button>}
