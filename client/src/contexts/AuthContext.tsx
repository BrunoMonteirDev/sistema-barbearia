...
type Auth = { user: Usuario | null; loading: boolean; signIn: (email: string, password: string) => Promise<void>; signInGoogle: (idToken: string) => Promise<void>; signUp: (nome: string, email: string, password: string) => Promise<void>; signOut: () => void }
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  return <Context.Provider value={{ user, loading, signIn, signInGoogle, signUp, signOut }}>{children}</Context.Provider>
}
